...
from src.components.travel_plan.domain.TravelPlanEntities import Place
from src.components.travel_plan.application.solvers.TspSolver import haversine_distance
