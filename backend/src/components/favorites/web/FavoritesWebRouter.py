...
class FavoritesWebRouter:
    ...
    def __call__(self, app: FastAPI, prefix: str = ''):
        ...
        app.add_api_route(
            ...
            description='Добавляет указанный маршрут в избранное текущего пользователя.',
        ...
        app.add_api_route(
            ...
            description='Возвращает список всех избранных маршрутов текущего пользователя.',
            endpoint=list_view.__call__,
        )

        app.add_api_route(
            path=f'{prefix}/favorites/{{trip_id}}',
            methods=['PATCH'],
            tags=['favorites'],
            response_model=FavoriteResponse,
            summary='Обновить название избранного',
            description='Обновляет пользовательское название избранного маршрута.',
        ...
        app.add_api_route(
            ...
            description='Удаляет указанный маршрут из избранного.',
