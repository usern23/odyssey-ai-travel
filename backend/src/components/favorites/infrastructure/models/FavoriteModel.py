...
class Favorite(Base):
    ...
    trip: Mapped['Trip'] = relationship(back_populates='favorites')

    def __repr__(self) -> str:
        return f'<Favorite(id={self.id}, user_id={self.user_id}, trip_id={self.trip_id})>'
