...
from src.components.agent.infrastructure.tools.strategic.LangchainPlanTools import create_travel_plan_tools
from src.components.agent.infrastructure.tools.LangchainAdapters import DestinationSuggesterLangTool, SuggestFlightsLangTool, TripDataCollectorLangTool, WebSearchLangTool, SearchPlacesLangTool, YouTubeSearchLangTool
...
class ToolsManager:
    ...
    def __init__(self, db_session: AsyncSession,
        ...
        self._youtube_search = YouTubeSearchTool()
            ...
            DestinationSuggesterLangTool(
                ...
                self._trip_data_collector), WebSearchLangTool(
                    self._web_search), SearchPlacesLangTool(
                        self._web_search), YouTubeSearchLangTool(
